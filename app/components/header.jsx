    ...
    return (
        <header className="bg-white px-4 py-3 flex items-center justify-between w-full max-w-6xl mx-auto md:pt-7">
            ...
            <div className="flex items-center gap-3">
                <Image className="mr-2 w-12 h-12 object-contain hidden sm:block" src={'/medical-icon.png'} width={48} height={48} alt="Logo" />
                <div>
            ...
            {/* Mobile menu */}
            {menuOpen && (
                <div className="absolute top-16 left-0 w-full bg-white shadow-md z-50 flex flex-col items-center md:hidden animate-fade-in">
